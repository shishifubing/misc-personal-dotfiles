...
gitversion_url="${github}/GitTools/GitVersion/releases/download"
dotfiles_repo="${github}/shishifubing-com/misc-personal-dotfiles.git"
helm_url="https://get.helm.sh"
yc_url="https://storage.yandexcloud.net/yandexcloud-yc"
terraform_docs_url="${github}/terraform-docs/terraform-docs/releases/download"
...
urls=(
    "${host}/terraform/${terraform_version}/${terraform_distrib}"
    "${host}/packer/${packer_version}/${packer_distrib}"
